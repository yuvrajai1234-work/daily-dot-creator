...
import { Check, X, UserPlus, Search, Loader2, UserCheck, Clock } from "lucide-react";
                        ...
                        <ScrollArea className="flex-1 -mr-3 pr-3 h-full">
                            <div className="space-y-2 pb-4">
                                {filteredFriends.map(friend => (
                                    <div key={friend.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-secondary/20 transition-colors cursor-pointer group">
