...
import { FullUserProfileDialog } from "./FullUserProfileDialog";
                            ...
                            <DropdownMenu>
                                ...
                                <DropdownMenuContent align="end">
                                    {friendStatus?.status === 'accepted' && (
                                        <>
                                            <DropdownMenuItem onClick={() => setIsProfileModalOpen(true)}>View Full Profile</DropdownMenuItem>
                                            <Separator className="my-1" />
                                        </>
                                    )}
                                    <DropdownMenuItem className="text-destructive" onClick={() => toast.success("User blocked successfully")}>Block</DropdownMenuItem>
                                    <DropdownMenuItem className="text-destructive" onClick={() => toast.success("User reported to moderators")}>Report User Profile</DropdownMenuItem>
                                </DropdownMenuContent>
                            </DropdownMenu>
                        )}
                    </div>
