...
-- ════════ 🌱 BEGINNER — Year 1 ════════
('First Step',          'Complete your very first habit.',       '👣', 'beginner', 'total_completions', 1,   5,  'common', 10,  1),
('Getting Started',     'Complete 10 habits.',                   '🚀', 'beginner', 'total_completions', 10,  15,  'common', 30,  1),
('Building Blocks',     'Complete 25 habits.',                   '🧱', 'beginner', 'total_completions', 25,  30,  'common', 60,  1),
('Habit Curious',       'Create your first habit.',              '✨', 'beginner', 'total_habits',      1,   5,  'common', 10,  1),
('Habit Collector',     'Create 3 different habits.',            '🗂️', 'beginner', 'total_habits',      3,   10,  'common', 20,  1),
('Dear Diary',          'Write your first reflection.',          '📔', 'beginner', 'total_reflections', 1,   5,  'common', 10,  1),
...
('Spark',              'Keep a 3-day streak.',                   '✨', 'streak', 'streak', 3,    6,    'common',    15,   1),
('Ignition',           'Keep a 5-day streak.',                   '🔥', 'streak', 'streak', 5,    10,    'common',    25,   1),
('One Week On Fire',   'Keep a 7-day streak.',                   '🎆', 'streak', 'streak', 7,    14,    'common',    40,   1),
('Fortnight Blaze',    'Keep a 14-day streak.',                  '🌠', 'streak', 'streak', 14,   28,   'rare',      60,   1),
('Month of Fire',      'Keep a 30-day streak.',                  '🏔️', 'streak', 'streak', 30,   60,   'rare',      100,  1),
('Sixty Burning Days', 'Keep a 60-day streak.',                  '🌋', 'streak', 'streak', 60,   120,   'epic',      175,  2),
('Triple Month',       'Keep a 90-day streak.',                  '🦅', 'streak', 'streak', 90,   150,   'epic',      250,  2),
('One-Year Flame',     'Keep a streak for 365 days.',            '🌞', 'streak', 'streak', 365,  700,  'legendary', 500,  3),
('Unstoppable Force',  'Keep a streak for 500 days.',            '⚡', 'streak', 'streak', 500,  500,  'legendary', 750,  4),
('The Unbroken',       'Keep a streak for 730 days (2 years).',  '🔱', 'streak', 'streak', 730,  730,  'legendary', 1000, 5),
('Six Month Surge',    'Keep a 180-day streak.',                 '🌊', 'streak', 'streak', 180,  180,  'epic',      350,  3),
('Nine Month Grind',   'Keep a 270-day streak.',                 '💎', 'streak', 'streak', 270,  270,  'legendary', 450,  3),
