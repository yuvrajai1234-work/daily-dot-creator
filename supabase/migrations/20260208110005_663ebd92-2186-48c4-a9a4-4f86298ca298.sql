...
INSERT INTO public.achievements (name, description, icon, category, requirement_type, requirement_value, coin_reward) VALUES
  ...
  ('3-Day Streak', 'Maintain a 3-day streak', '🔥', 'streak', 'streak', 3, 6),
  ('Week Warrior', 'Maintain a 7-day streak', '⭐', 'streak', 'streak', 7, 14),
  ('Two Week Champion', 'Maintain a 14-day streak', '🏅', 'streak', 'streak', 14, 28),
  ('Monthly Master', 'Maintain a 30-day streak', '👑', 'streak', 'streak', 30, 60),
